import unittest
from src.extractors.phone.phoneNumberExtractor import NumberExtractor, filter_on_number_is_date, filter_on_number_contains_only_one_parenthesis_pair, filter_on_minus_only_between_two_numbers
...
class Basefilter_on_number_prefix_and_sufix_test(unittest.TestCase):
    ...
    def test_numbers_at_beggining_and_end_of_line(self):
        candidate_list= [("", "+385123456", " "), ("", "+385123456", "  "), (" ", "+385123456", ""), ("", "+385123456", "")]
    ...
    def test_numbers_before_unvalid_char(self):
        candidate_list = [("a", "+385123456", " "), (".", "+385123456", " "), (",", "+385123456", " "), ("!", "+385123456", " ")]
    ...
    def test_numbers_after_unvalid_char(self):
        candidate_list = [(" ", "+385123456", "a"), (" ", "+385123456", "a "), (" ", "+385123456", "!"), (" ", "+385123456", "! ")
    ...
    def test_couple_valind_and_couple_invalid(self):
        valid_candidates = [(" ", "+385123456", " "), (" ", "+385123456", ", "), ("", "+385123456", ""), (" ", "+385123456", ". "), (" ", "+385123456", ""), (" ", "+385123456", ", ")]
        invalid_candidates = [(" ", "+385123456", ".."), (" ", "+385123456", ".2 "), ("", "+385123456", "! "), (".", "+385123456", ""), (",", "+385123456", ""), ("a", "+385123456", ", "), ("-", "+385123456", ", ")]
